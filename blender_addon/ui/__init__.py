...
- :mod:`blender_addon.ui.operators`   run/stop job operators + round-trip operators
"""
...
def register() -> None:
    ...
    # Phase B: round-trip operators
    for op_class in operators.ROUND_TRIP_OPERATORS:
        compat.register_class(op_class)
...
def unregister() -> None:
    ...
    # Phase B: round-trip operators (reverse order)
    for op_class in reversed(operators.ROUND_TRIP_OPERATORS):
        compat.unregister_class(op_class)
