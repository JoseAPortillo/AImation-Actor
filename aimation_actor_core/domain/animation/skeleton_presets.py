...
DEFAULT_NEUTRAL_SKELETON = Skeleton(
    bones={
        ...
        # Legs: X offset for lateral separation (left=-8, right=+8)
        "LUpLeg": Bone(name="LUpLeg", parent="Hips", rest_position=(-8.0, -8.0, 0.0)),
        ...
        "RUpLeg": Bone(name="RUpLeg", parent="Hips", rest_position=(8.0, -8.0, 0.0)),
